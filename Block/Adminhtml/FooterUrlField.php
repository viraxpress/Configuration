...
class FooterUrlField extends AbstractFieldArray
{
    /**
    ...
    {
        $this->addColumn('link', ['label' => __('Select Link'), 'renderer' => $this->_getLinkRenderer(), 'class' => 'required-entry']);
    ...
    protected function _getLinkRenderer()
    {
        $renderer = $this->getLayout()->createBlock(
            \ViraXpress\Configuration\Block\Adminhtml\Form\Field\Link::class,
            '',
